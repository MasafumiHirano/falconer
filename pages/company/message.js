      ...
      <Layout>
        <main class="-mb-4 NotoSans">
          ...
          <div class="mb-12 md:mb-24">
            ...
            <div class="w-90% md:w-1080 mx-auto mt-8 md:mt-52">
              {/*intro*/}
              <section>
                <div class="py-20 border-t border-b border-gray-700">
                  <img src="/images/company/intro.jpg" class="block mx-auto" />
                  <p class="w-full lg:w-1050 px-6 text-justify mt-12 mx-auto text-base_s lg:text-xl font-light">毎月仕事で様々な国を訪れて解った事があります。日本人の多くはとにかく顔が暗いのです。日本の長い歴史を振り返ってもどれほどの期間が天下太平だったのでしょう。衣食住・衛生・治安的に安定した生活がほとんどの人に与えられてる今なぜこんなにも日本人の心や顔は暗いのでしょうか。<br /><br />
              ...
              <section class="flex flex-wrap md:flex-nowrap mt-11 md:mt-28">
                ...
                <div class="w-full md:w-4/12">
                  <h2 class="NotoSans mx-auto flex justify-center items-center text-base font-thin md:text-4xl message_title">Message.1</h2>
                </div>
                {/*テキスト*/}
                <div class="w-full md:w-8/12">
                  ...
                  <div class="pb-3 md:pb-4">
                    <div class="flex justify-center flex-wrap">
                      <h3 class="NotoSans font-medium mt-10 md:mt-0 md:pt-1 text-comGOLD text-base lg:text-4xl">「照于一隅」一隅を照らす</h3>
                    </div>
                  </div>
                  {/*本文*/}
                  <div class="mt-4 text-justify NotoSans text-base_s md:text-lg leading-6 md:leading-7">
              ...
              <section class="flex flex-wrap md:flex-nowrap mt-11 md:mt-28">
                {/*タイトルブロック*/}
                <div class="w-full md:w-4/12 lg:order-2">
                  <h2 class="NotoSans mx-auto flex justify-center items-center text-base font-thin md:text-4xl message_title">Message.2</h2>
                </div>
                {/*テキスト*/}
                <div class="w-full md:w-8/12 lg:order-1">
                  ...
                  <div class="pb-3 md:pb-4">
                    <div class="flex justify-center flex-wrap">
                      <h3 class="NotoSans font-medium mt-10 md:mt-0 md:pt-1 text-comGOLD text-base lg:text-4xl">万物への感謝を胸に秘めて生きていく</h3>
                    </div>
                  </div>
                  {/*本文*/}
                  <div class="mt-4 text-justify NotoSans text-base_s md:text-lg leading-6 md:leading-7">
              ...
              <section class="flex flex-wrap md:flex-nowrap mt-11 md:mt-28">
                {/*タイトルブロック*/}
                <div class="w-full md:w-4/12">
                  <h2 class="NotoSans mx-auto flex justify-center items-center text-base font-thin md:text-4xl message_title">Message.3</h2>
                </div>
                {/*テキスト*/}
                <div class="w-full md:w-8/12">
                  {/*経歴*/}
                  <div class="pb-3 md:pb-4">
                    <div class="flex justify-center flex-wrap">
                      <h3 class="NotoSans font-medium mt-10 md:mt-0 md:pt-1 text-comGOLD text-base lg:text-4xl md:leading-10 text-center lg:text-left">強くなければ生きていけない、<span class="block">優しくなければ生きていく資格がない</span></h3>
                    </div>
                  </div>
                  {/*本文*/}
                  <div class="mt-4 text-justify NotoSans text-base_s md:text-lg leading-6 md:leading-7">
              ...
              <section class="flex flex-wrap md:flex-nowrap mt-11 md:mt-28 mb-11 md:mb-28">
                {/*タイトルブロック*/}
                <div class="w-full md:w-4/12 lg:order-2">
                  <h2 class="NotoSans mx-auto flex justify-center items-center text-base font-thin md:text-4xl message_title">Message.4</h2>
                </div>
                {/*テキスト*/}
