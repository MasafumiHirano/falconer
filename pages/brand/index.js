      ...
      <Layout>
        <main>
          <div class="mx-auto pt-6 lg:pt-12 lg:mb-12 lg:w-1100">
            <h1 class="Osaka font-bold text-3xl text-center mb-6 py-2">ブランド</h1>
            <div class="block mx-auto lg:flex lg:px-0 mt-6 mb-6 lg:mt-12">
              <div class="lg:w-1/2 relative w-full">
                <Image className="object-cover" src="/images/brand/brand-ba2.jpg" alt="bachicashley" width={1100} height={550} />
