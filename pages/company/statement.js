          ...
          <div class="mx-auto pt-8 pb-16 bg-opacity-75" style={{ width: "1100px" }}>
            ...
            <div class="text-white mx-40 mt-24">
              ...
              <div class="text-center tracking-widest mt-5" >
                ...
                <div class="mb-8 text-xl leading-8">
            ...
            <div class="text-white mx-40 mt-24">
              <div>
                <h1 class="text-3xl text-center font-bold border-b-4 pb-2">代表メッセージ</h1>
              </div>
              <div class="text-center tracking-widest mt-16" >
            ...
            <div class="flex flex-row mx-40" style={{ width: "1100px" }}>
              <div>
                <Image src="/images/company/ceo_img.jpg" width={240} height={240} alt="ceo_img"/>
              </div>
              <div class="text-lg text-white pt-6 pl-10">
                <p>代表プロフィール</p>
                <p class="text-xl py-6">清水真輝</p>
                <p class="text-lg pb-6">1987年11月27日生まれ AB型</p>
                <p class="text-lg">名古屋市出身</p>
                <p class="text-lg">愛知高校・名古屋学院大学英米科卒業</p>
              </div>
            </div>
          </div>
        </div>
