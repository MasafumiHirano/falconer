...
export default function catalog7363() {
  return (
    <div>
      <Head>
        <title>waa7363</title>
      ...
      <Layout>
        <main role="main" class="pt-8 NotoSans">
          <section class="flex flex-wrap justify-center p-7">
            ...
            <p class="py-6 text-black-900 text-xl font-bold w-4/5 text-center">コインケース</p>
            <div class="w-5/12"><img src="/images/catalog/7363.jpg" /></div>
            <dl class="w-6/12 pl-8">
              <dt class="bg-red-200 px-4 flex items-center font-bold">型番</dt><dd class="pt-4 pb-7 ml-7">7363</dd>
              <dt class="bg-red-200 px-4 flex items-center font-bold">売価</dt><dd class="pt-4 pb-7 ml-7">メーカー希望小売価格：¥2,200</dd>
              <dt class="bg-red-200 px-4 flex items-center font-bold">ブランド</dt><dd class="pt-4 pb-7 ml-7">RafiCaro</dd>
              <dt class="bg-red-200 px-4 flex items-center font-bold">サイズ</dt><dd class="pt-4 pb-7 ml-7">縦 30mm × 横 75mm × 厚み 28mm ／ 重さ 15g</dd>
              <dt class="bg-red-200 px-4 flex items-center font-bold">素材</dt><dd class="pt-4 pb-7 ml-7">本革 シュリンクレザー</dd>
              <dt class="bg-red-200 px-4 flex items-center font-bold">カラー</dt>
              <dd class="pt-4 pb-7 ml-7">sgreen (JAN:4589681976010) / sdustypink (JAN:4589681976027) / sgreige (JAN:4589681976034) / sblack (JAN:4589681976041) / sorange (JAN:4589681976058) / sblue (JAN:4589681976065) / syellow (JAN:4589681976072) / slightgrey (JAN:4589681982387)</dd>
