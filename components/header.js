      ...
      <div class="flex mx-auto w-full lg:w-1280">
        ...
        <div class="w-1/2 lg:w-3/12">
          <div class="py-4 lg:py-6">
            <Link href="/">
              <a>
                <svg class="w-full" xmlns="http://www.w3.org/2000/svg" fill={`${logo_color}`} viewBox="0 0 956.944 110.729">
          ...
          <div class="flex invisible lg:visible">
            <div class="flex items-center px-2">
              <a class="pt-1" href="https://www.instagram.com/masaki.s_japan/" target="_black">
                <svg xmlns="http://www.w3.org/2000/svg" fill={`${logo_color}`} width="32" height="32" viewBox="0 0 24 24">
