    ...
    <div>
      ...
      <main class="lg:pb-12" style={{ backgroundColor: "#ffffff" }}>
        <div class="mx-auto  bg-white px-4 lg:px-12 mb-8 lg:mb-24 lg:w-1100">
          <h1 class="text-center text-2xl lg:text-4xl lg:mt-12 bg-falGLD text-white py-2">社の強み</h1>
          <div class="my-8 lg:mt-12 lg:mb-4">
            <h1 class="text-center font-bold text-2xl mb-6 lg:text-4xl lg:mb-12">最高品質の戦略的モノ作りカンパニー</h1>
          ...
          <p class="text-sm lg:text-base mb-6">お客様へお届けするまでのすべての業務を自社で行い、世界各地を生産拠点・販売拠点に商品ごとの品質・技術管理を行っています。</p>
