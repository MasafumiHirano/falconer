    ...
    <div>
      ...
      <main>
          <div style={{backgroundColor: "#786b58"}}>
            <div class="mx-auto py-2 bg-opacity-75" style={{ width: "1100px" }}>
              <div class="text-white mx-10">
                <div>
                  <h1 class="text-4xl text-center border-b-2 mb-6 mt-2 pb-2">VISION</h1>
                </div>
                <div class="px-56 text-center" >
                  <h1 class="text-2xl mb-8 font-bold tracking-widest">今日よりも、もっと幸せな明日を。</h1>
                  <div class="mb-8">
                    <p>高品質かつワクワクする商品を生み出し、</p>
                    <p class="mt-2">お客様の生活をより豊かで幸せなものにすること。</p>
                  </div>
                  <div class="mb-8">
                    <p>お客様だけでなく、社会・社員・関係各社、</p>
                    <p class="mt-2">関わる全ての人々の幸せと発展に貢献すること。</p>
                  </div>
                  <div class="mb-8">
                    <p>地球環境の保全を心がけ、永続的な発展をするために</p>
                    <p class="mt-2">無駄のない流通・運営を行い、毎日の成長を続けること。</p>
                  </div>
                </div>
              </div>
              
              <div class="bg-white mt-10 mb-2 mx-10">
                <div><h1 class="text-2xl text-center border-b-4  mx-10 pt-6 pb-4 font-semibold" style={{borderColor: "#786b58"}}>代表メッセージ</h1></div>
                <div class="text-center flex flex-row my-10 mx-10">
                  <div class="w-1/5">
                    <Image src="/images/company/ceo_img.jpg" width={120} height={120} alt="ceo_img"/>
                    <p>代表者 Profile</p>
                  </div>
                  <div class="w-4/5">
