            ...
            <ul class="mx-auto w-90% md:px-0 md:w-1050 mt-6">
              {
                topics
                  ...
                  .map(topics => (
                    <li key={topics.id}>
                      <Link href={topics.link && topics.link}>
                        <a class="flex flex-wrap md:flex-nowrap text-sm md:text-base md:flex-row py-4 border-b" target="blank_">
