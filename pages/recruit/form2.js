      ...
      <Layout>
        <main class="bg-gray-100">
          <div class="mx-auto pt-12 lg:w-1100">
            <p class="text-center mb-4 text-xl">【パート・アルバイト】</p>
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <div class="mt-1 ">
                        <div class="ml-2 inline-block">
                          <input type="radio" name="type" id="type" autocomplete="organization" value={"事務処理STAFF（パート・アルバイト）"} onChange={e => setType(e.target.value)} />
                          <label for="type" class="pl-2">事務処理STAFF（パート・アルバイト）</label>
                        </div>
                      </div>
                    </div>
