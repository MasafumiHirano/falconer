            ...
            <div class="w-90% md:w-1080 mx-auto mt-8 md:mt-52">
              ...
              <section>
                <div class="py-20 border-t border-b border-gray-700">
                  ...
                  <p class="w-full lg:w-1050 px-6 text-justify mt-12 mx-auto text-sm lg:text-xl font-light">毎月仕事で様々な国を訪れて解った事があります。日本人の多くはとにかく顔が暗いのです。日本の長い歴史を振り返ってもどれほどの期間が天下太平だったのでしょう。衣食住・衛生・治安的に安定した生活がほとんどの人に与えられてる今なぜこんなにも日本人の心や顔は暗いのでしょうか。<br /><br />
              ...
              <section class="flex flex-wrap md:flex-nowrap mt-11 md:mt-28">
                ...
                <div class="w-full md:w-4/12">
                  <h2 class="NotoSans mx-auto flex justify-center items-center text-lg font-thin md:text-4xl message_title">Message.1</h2>
                </div>
                {/*テキスト*/}
                <div class="w-full md:w-8/12">
                  ...
                  {/*本文*/}
                  <div class="mt-4 text-justify NotoSans text-sm md:text-lg leading-6 md:leading-7">
              ...
              <section class="flex flex-wrap md:flex-nowrap mt-11 md:mt-28">
                ...
                <div class="w-full md:w-4/12 lg:order-2">
                  <h2 class="NotoSans mx-auto flex justify-center items-center text-lg font-thin md:text-4xl message_title">Message.2</h2>
                </div>
                {/*テキスト*/}
              ...
              <section class="flex flex-wrap md:flex-nowrap mt-11 md:mt-28">
                {/*タイトルブロック*/}
                <div class="w-full md:w-4/12">
                  <h2 class="NotoSans mx-auto flex justify-center items-center text-lg font-thin md:text-4xl message_title">Message.3</h2>
                </div>
                {/*テキスト*/}
                <div class="w-full md:w-8/12">
                  {/*経歴*/}
              ...
              <section class="flex flex-wrap md:flex-nowrap mt-11 md:mt-28 mb-11 md:mb-28">
                {/*タイトルブロック*/}
                <div class="w-full md:w-4/12 lg:order-2">
                  <h2 class="NotoSans mx-auto flex justify-center items-center text-lg font-thin md:text-4xl message_title">Message.4</h2>
                </div>
                {/*テキスト*/}
