...
export default function Strength() {
  return (
    <div>
      ...
      <Layout>
      <main class="pt-12 lg:pb-12" style={{ backgroundColor: "#ffffff" }}>
        <div class="mx-auto  bg-white lg:px-12 mb-8 lg:mb-24 lg:w-1100">
          <h1 class="text-center text-2xl lg:text-4xl my-6 lg:my-12 bg-black text-white py-2">社の強み</h1>
          ...
          <div class="flex justify-center py-2 px-4 mb-12 lg:mb-24">
