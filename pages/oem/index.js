    ...
    <div>
      <main class="chuGo">
        <div class="oem_main_image h-640 lg:h-1000 bg-cover relative">
          <div class="text-center absolute bottom-40 w-full"><button class="px-60 py-6 bg-falNAVY text-white">CONTACT</button></div>
          <p class="text-center absolute bottom-24 w-full text-falNAVY text-25px">革製品のOEM/ODMならお任せください。</p>
        </div>
