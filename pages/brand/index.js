          ...
          <div class="mx-auto pt-6 lg:pt-12 lg:mb-12 lg:w-1100">
            ...
            <div class="block mx-auto lg:flex lg:px-0 mt-6 mb-6 lg:mt-12">
              <div class="lg:w-1/2 relative w-full">
                <Link href="//bachicashley.com/"><a target="blank_"><Image className="object-cover" src="/images/brand/brand-ba2.jpg" alt="bachicashley" width={1100} height={550} /></a></Link>
              ...
              <div class="lg:w-1/2 relative w-full lg:ml-8 mt-12 lg:mt-0">
                <Link href="//lurverri.com/"><a target="blank_"><Image className="object-cover" src="/images/brand/lv_hero.jpg" alt="bachicashley" width={1100} height={550} /></a></Link>
