      ...
      <Layout>
        <main class="lg:pb-12" style={{ backgroundColor: "#ffffff" }}>
          ...
          <div class="mb-6 lg:mb-12">
            <div class="relative">
              <h1 class="strength_title futura-lt text-white text-center font-bold text-3xl lg:text-3xl h-405 flex items-center justify-center flex-col">Story<p class="NotoSans-L text-base">ストーリー</p></h1>
            </div>
          </div>
          {/*見出し部分 終了*/}
          <div class="mt-44 lg:flex lg:justify-center">
          ...
          <div class="border-t-2 border-b-2 border-gray-600 py-10 w-300 lg:w-49% mx-auto mt-44">
            <img src="/images/company/ourstrength.png" class="block mx-auto" />
            <div class="NotoSans-L md:w-600 mx-auto mt-4 mb-7 text-lg">
          ...
          <div class="self_maker w-full md:h-900 mt-36 flex justify-center items-center">
            <div class="w-full md:w-500">
              <h3 class="flex items-center text-xl"><img src="/images/company/shape.png" class="mr-1" />中間業者を徹底排除した自社製造</h3>
              <div class="NotoSans-L text-base">
            ...
            <div class="w-full md:w-auto md:ml-24">
              <img src="/images/company/spc_system.png"/>
            </div>
          </div>
          <div class="it_management w-full md:h-900 flex justify-center items-center">
            <div class="w-full md:w-500 text-white order-1 md:order-2">
              <h3 class="flex items-center text-xl"><img src="/images/company/shape.png" class="mr-1" />IT技術を活用した生産管理</h3>
              <div class="NotoSans-L text-base">
            ...
            <div class="w-full md:w-auto md:mr-24 order-2 md:order-1">
          ...
          <div class="mt-32 mb-40 lg:flex lg:justify-center">
            <p class="NotoSans-L px-3 text-base md:text-lg text-left md:text-center lg:mb-2">
