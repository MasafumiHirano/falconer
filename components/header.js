    ...
    <>
      ...
      <div className="header">
        <div className="header__contents mx-auto w-full">
          ...
          <div className="w-5/6 md:w-64 pr-1 lg:max-w-lg">
            <div className="py-4 md:pl-20 lg:py-6">
              <Link href="/">
                <a class="flex flex-col">
                  ...
                  <p class="text-0.55rem md:text-xs min-w-100 md:ml-0 mr-1 flex items-center NotoSans-L">株式会社FALCONER</p>
                  <svg version="1.1" id="レイヤー_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 228 32" class="mx-3 ml-0 md:mx-0">
                  <g fill="black">
