    ...
    return (
        <div class="">
          <button onClick={toggleDrawer}>
            <svg xmlns="http://www.w3.org/2000/svg" fill={`${logo_color}`} width="24" height="24" viewBox="0 0 640 1024" role="img">
          ...
          <Drawer open={isOpen} onClose={toggleDrawer} direction='left' style={{width: "65%"}}>
            <div class="bg-black h-screen pt-6 text-white tracking-wide leading-10">
              <ul class="pl-8">
                <li class="hover:text-falGLD text-lg"><Link href="/topics"><a>新着情報</a></Link></li>
