      ...
      <main>
        <div style={{backgroundColor: "#786b58"}}>
          <div class="mx-auto pt-12 pb-12" style={{ width: "1100px" }}>
            {/*見出し部分*/}
            <div class="flex pb-2 border-b-2 border-solid border-white mb-12">
              <div class="w-1/4"><p>{`　`}</p></div>
              <div class="w-2/4">
                <h1 class="text-4xl text-center text-white">MEDIA</h1>
                </div>
              <div class="w-1/4">
            ...
            <div class="px-6 pt-8 bg-white border-2 border-solid border-black">
              <section class="mb-24">{/*RadioSection*/}
                <h1 class="text-5xl text-center mb-6 midashiGo">RADIO</h1>
                <div class="mb-6">
                  <Image src="/images/media/bond_jam.jpg" alt="radio-image" width={1100} height={227} />
                </div>
                <div>
                  <p class="chuGo text-2xl mb-4">MC: NANAMI 清水真輝</p>
                  <p class="chuGo text-2xl mb-4">BACHIC ASHLEY がプロデュースする日常を最高の気分で過ごすために毎日を日々、</p>
                  <p class="chuGo text-2xl mb-4">力強く生きているアーティスト、クリエイター、経営者など、各界の最先端で活躍する方々を</p>
                  <p class="chuGo text-2xl mb-6">ゲストとしてお招きし、その強さの秘訣とこだわりの人生についてお聞きします。</p>
                  <p class="chuGo text-xl">FM 愛知　毎週20：00～20：30　OA</p>
                </div>
              </section>{/*RadioSectionEnd*/}
              <section class="mb-24">{/*YoutubeSection*/}
                <div class="flex justify-center mb-6">
                  <div class="flex items-center">
                    <h1 class="text-5xl text-center mr-6 midashiGo">Youtube Channel</h1>
                ...
                <div class="flex pt-6 pb-6 mb-4" style={{ backgroundColor: "#221916" }}>
                  ...
                  <div class="w-1/4">
                    <div class="flex justify-center items-center h-1/2">
                      <iframe width="90%" height="90%" src="https://www.youtube.com/embed/CmNI0Xe8OoU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <div class="flex justify-center items-center h-1/2">
                      <iframe width="90%" height="90%" src="https://www.youtube.com/embed/CmNI0Xe8OoU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                ...
                <div>
                  <p class="chuGo text-2xl mb-4">BACHIC ASHLEY がプロデュースするラジオ番組「Bond Jam」のアーカイブからブランド、</p>
                  <p class="chuGo text-2xl mb-4">企業情報まで株式会社ファルコナーの魅力をYouTube コンテンツで発信します。</p>
                </div>
              </section>{/*YoutubeSectionEnd*/}
              <section class="mb-24">{/*SNSSection*/}
                <h1 class="text-6xl text-center mr-6 midashiGo mb-16">SNS</h1>
                <div class="flex">
