            ...
            <div class="text-white">
              ...
              <div class="text-center tracking-widest mt-5 lg:mt-16" >
                <div class="lg:flex lg:justify-center">
                  <h1 class="text-xl lg:text-2xl lg:mb-6 font-bold">先人達を尊び、感謝をし、</h1>
                  <h1 class="text-xl lg:text-2xl mb-6 font-bold">天命を尽くす</h1>
                </div>
                <div class="text-left">
              ...
              <div class="text-center tracking-widest mt-16" >
                <h1 class="text-xl lg:text-2xl mb-6 font-bold">「照于一隅」一隅を照らす</h1>
                <div class="text-left">
                  <div class="mb-8 text-base lg:text-xl leading-8">
              ...
              <div class="text-center tracking-widest mt-16" >
              <div class="lg:flex lg:justify-center">
                  <p class="text-xl lg:text-2xl lg:mb-6 font-bold">強くなければ</p>
                  <p class="text-xl lg:text-2xl lg:mb-6 font-bold">生きていけない、</p>
              </div>
              <div class="lg:flex lg:justify-center">
                  <p class="text-xl lg:text-2xl lg:mb-6 font-bold mt-3 lg:mt-0">優しくなければ</p>
                  <p class="text-xl lg:text-2xl lg:mb-6 font-bold">生きていく資格がない</p>
              </div>
              <div class="lg:flex lg:justify-center">
                  <p class="text-xl lg:text-2xl lg:mb-6 font-bold mt-3 lg:mt-0">愛なき力は暴力、</p>
                  <p class="text-xl lg:text-2xl mb-6 font-bold">力なき愛は無力である。</p>
              </div>
                <div class="text-left">
                  <div class="mb-8 text-base lg:text-xl leading-8">
              ...
              <div class="lg:flex lg:justify-center">
                ...
                <h1 class="text-2xl mb-6 font-bold">衣食の中に道心なし</h1>
              </div>
                <div class="text-left">
                  <div class="mb-8 text-base lg:text-xl leading-8">
