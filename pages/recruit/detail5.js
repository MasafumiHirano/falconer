            ...
            <div class="mx-auto lg:w-1100 pb-16 px-4 lg:px-20">
              ...
              <div class="pt-4 lg:pt-12">
                <div class="bg-white shadow-lg p-6">
                  <p class="text-center text-lg lg:text-2xl font-semibold">【事務STAFF】 ＜2～3名募集！＞平日のみ♪お休み相談も◎ネイル/服装などオシャレ自由</p>
                </div>
              </div>

              <div class="text-yellow-600 font-semibold border-b border-gray-700 pb-4 mt-4 lg:mt-8 text-xs lg:text-lg">
                <p class="pl-4">レザーアイテムのネットショップ運営の事務処理サポート！</p>
              ...
              <h2 class="mt-8 text-lg lg:text-2xl font-semibold border-b border-gray-700">仕事内容</h2>

              <div class="mt-4 lg:mt-8 text-xs lg:text-lg">
                <p>【 レザーアイテムをオンラインショップで取り扱っています♪ 】</p>
              </div>
              ...
              <div class="mt-4 lg:mt-8">
                ...
                <div class="mt-4">
                  ...
                  <div class="text-xs lg:text-lg">
                    <p>お客様からいただいた質問に対してメールや電話で回答します。</p>
